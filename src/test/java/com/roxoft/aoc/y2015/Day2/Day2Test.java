...
public class Day2Test {
    @Test
    public void requirement_surfaceAreaCalculated(){
        //2*l*w + 2*w*h + 2*h*l
        assertEquals(6, Day2.of(1,1,1).getSurfaceArea());
        assertEquals(52, Day2.of(2,3,4).getSurfaceArea());
        assertEquals(42, Day2.of(1,1,10).getSurfaceArea());
    }

    @Test
    public void assumption_equals(){
        final Day2 x = Day2.of(99,99,99);
        assertEquals(x,x);

        assertEquals(Day2.of(1,1,1), Day2.of(1,1,1));
        assertEquals(Day2.of(9,1,9), Day2.of(9,1,9));
        assertEquals(Day2.of(1,45,1), Day2.of(1,45,1));

        assertNotEquals(Day2.of(1,1,1), Day2.of(2,2,2));
        assertNotEquals(Day2.of(1,1,1), Day2.of(1,2,2));
        assertNotEquals(Day2.of(1,1,1), Day2.of(2,2,1));
        assertNotEquals(Day2.of(1,1,1), Day2.of(2,1,2));

        assertNotEquals(x, null);
        assertNotEquals(x, "This is definitely not equal");
    }

    @Test
    public void assumption_hashcode(){
        final Day2 x = Day2.of(99,99,99);
        assertEquals(x.hashCode(), x.hashCode());

        assertEquals(Day2.of(1,1,1).hashCode(), Day2.of(1,1,1).hashCode());
        assertEquals(Day2.of(9,1,9).hashCode(), Day2.of(9,1,9).hashCode());
        assertEquals(Day2.of(1,45,1).hashCode(), Day2.of(1,45,1).hashCode());

        assertNotEquals(Day2.of(1,1,1).hashCode(), Day2.of(2,2,2).hashCode());
        assertNotEquals(Day2.of(1,1,1).hashCode(), Day2.of(1,2,2).hashCode());
        assertNotEquals(Day2.of(1,1,1).hashCode(), Day2.of(2,2,1).hashCode());
        assertNotEquals(Day2.of(1,1,1).hashCode(), Day2.of(2,1,2).hashCode());
    }

    @Test
    public void example_A1(){
        assertEquals(58, Day2.of(2,3,4).getRequiredWrappingPaper());
    }

    @Test
    public void example_A2(){
        assertEquals(43, Day2.of(1,1,10).getRequiredWrappingPaper());
    }

    @Test
    public void solution_A(){
        final String[] lines = puzzleInput.split("\n");

        assertEquals(1598415, Arrays
                .stream(lines)
                .mapToInt(line -> Parser.parsing(line).asDay2Entry().getRequiredWrappingPaper())
                .sum());
    }

    @Test
    public void requirement_ribbonToWrap(){
        /**
         ...
         * is equal to the cubic feet of volume of the present. Don't ask how they tie the bow, though; they'll never
         * tell.
         * A present with dimensions 2x3x4 requires 2+2+3+3 = 10 feet of ribbon to wrap the present
         */
        assertEquals(10, Day2.of(2,3,4).getRequiredRibbonToWrap());
        /**
         * A present with dimensions 1x1x10 requires 1+1+1+1 = 4 feet of ribbon to wrap the present
         */
        assertEquals(4, Day2.of(1,1,10).getRequiredRibbonToWrap());
    }

    @Test
    public void requirement_ribbonToMakeBow(){
        /**
         * Each present also requires a bow made out of ribbon as well; the feet of ribbon required for the perfect bow
         * is equal to the cubic feet of volume of the present.
         * 2x3x4 = 2*3*4 = 24 feet of ribbon for the bow, for a total of 34 feet.
         */
        assertEquals(24, Day2.of(2,3,4).getRequiredRibbonToMakeBow());
        /**
         * 1x1x10 = 1*1*10 = 10 feet of ribbon for the bow, for a total of 14 feet.
         */
        assertEquals(10, Day2.of(1,1,10).getRequiredRibbonToMakeBow());
    }

    @Test
    public void example_B1(){
        assertEquals(34, Day2.of(2,3,4).getRequiredRibbon());
    }

    @Test
    public void example_B2(){
        assertEquals(14, Day2.of(1,1,10).getRequiredRibbon());
    }
    ...
    public void solution_B(){
        ...
        assertEquals(3812909, Arrays
                .stream(lines)
                .mapToInt(line -> Parser.parsing(line).asDay2Entry().getRequiredRibbon())
                .sum());
    }
